...
namespace Salon.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> MyReport(string? saleType, string? paymentMethod, int? employeeId, string? date)
        {
            ...
            string[] cashMethods  = { "كاش", "نقدي" };
            string[] knetMethods  = { "كي نت", "بطاقة", "تحويل بنكي" };
            string[] mixedMethods = { "كي نت و كاش", "مناصفة" };
            string[] debtMethods  = { "دين على العميل", "دين على الموظف", "دين على صاحب المكان", "آجل" };
