...
{
    /// <summary>قيمة موزّعة على الأقسام الإيرادية (حلاقة/مساج) بالإضافة للإجمالي العام.</summary>
    ...
    public class DashboardViewModel
    {
        ...
        /// <summary>نطاق العرض حسب صلاحية المستخدم: All (أدمن/مدير) | Haircut | Massage (سكرتير قسم) | Personal (موظف)</summary>
